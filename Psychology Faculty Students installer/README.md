...
after you have SSD/HDD with Lubuntu installed then open firefox browser to download our installer (JCS-Psychology-Faculty-students-installerVer01.AppImage) and double click it to run it.
