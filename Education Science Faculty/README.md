...
after you have SSD/HDD with Lubuntu installed then open firefox browser to download our installer (JCS-Education-Science-Faculty-Student-V1.AppImage) and double click it to run it.
